                    ...
                    <tr>
                        ...
                        <td class="ms-6">
                            <a href="{{ route('post.show', $post->id) }}" title="view full post"
                                class="btn ms-4 btn-success waves-effect waves-light "><i
                                    class="mdi mdi-eye"></i></i></a>
                            <a href="{{ route('post.edit', $post->id) }}"
                                class="btn ms-3 btn-primary waves-effect waves-light "><i
                                    class="mdi mdi-pencil"></i></i></a>
                            <a href="{{ route('post.delete', $post->id) }}"
                                class="btn ms-3 btn-danger waves-effect waves-light"><i
